            ...
            <div class="col-md-6 p-2 mb-3">
                <div class="card pull-right" style="width: 20rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><input type="checkbox" name="licences[]" value="Microsoft Office License"> Microsoft Office License</li>
                        <li class="list-group-item"><input type="checkbox" name="licences[]" value="Microsoft Office License"> Email Access Granted</li>
                        <li class="list-group-item"><input type="checkbox" name="licences[]" value="Microsoft Office License"> Git Repository Granted</li>
                        <li class="list-group-item"><input type="checkbox" name="licences[]" value="Microsoft Office License"> Jira Access Granted</li>
                    </ul>
                    </form>
                </div>
            </div>
    ...
    <div class="card card-body mb-3">
        ...
        <div class="row mb-3 mt-3">
                                    ...
                                    <?php if ($groups->user_id != $_SESSION['user_id']) : ?>
                                            <?php else: ?>
                                                <tr>
                                                    ...
                                                    <td><form class="pull-right ml-5 pt-3"
            ...
            <div class="col-md-4 p-2 mb-3">
                <div class="card t" style="width: 20rem;">
                    <div class="card-header">
                        Licences
                    </div>
                    <ul class="list-group list-group-flush">
